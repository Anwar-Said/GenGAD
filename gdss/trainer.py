...
class Trainer(object):
    ...
    def train(self, ts):
        ...
        wandb.init(project= 'Anomaly Detection', config = self.config)
        ...
        for epoch in trange(0, (self.config.train.num_epochs), desc = '[Epoch]', position = 1, leave=False):
            ...
            wandb.log({"mean_train_x": mean_train_x, 
                        "mean_train_adj": mean_train_adj, 
                        "mean_test_x": mean_test_x, 
                        "mean_test_adj": mean_test_adj})
