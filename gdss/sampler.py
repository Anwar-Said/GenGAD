...
from utils.graph_utils import adjs_to_graphs, init_flags, quantize, quantize_mol, adjs_x_to_graphs
...
class Sampler(object):
    ...
    def sample(self):
        ...
        for r in range(num_sampling_rounds):
            ...
            gen_graph_list.extend(adjs_x_to_graphs(samples_int,x, True)) # this part is changed for the anomaly detection task
